...
public class Solution
{
    ...
    {
        for(Apartament apartamentFor : apartaments)
        {
            if (apartamentFor instanceof Apt1Room)
                ((Apt1Room) apartamentFor).clean1Room();
            if (apartamentFor instanceof Apt2Room)
                ((Apt2Room) apartamentFor).clean2Rooms();
            if (apartamentFor instanceof Apt3Room)
                ((Apt3Room) apartamentFor).clean3Rooms();
        }
    }
