...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        Person person = null;
        String key = null;
        ArrayList<String> list = new ArrayList<>( Arrays.asList("user","looser","coder","proger"));
        while (true)
        {
            key = reader.readLine();
            ...
            else if (key.equals(list.get(1)))
                person = new Person.Looser();
            else if (key.equals(list.get(2)))
                person = new Person.Coder();
            else if (key.equals(list.get(3)))
